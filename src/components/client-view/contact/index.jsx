              ...
              <div className="flex flex-wrap -m-2">
                    ...
                    <div className="p-2 w-full">
                      <div className="relative">
                        ...
                        <textarea
                          ...
                          className="w-full border-orange-600 border-[2px] bg-white rounded  h-32 text-base outline-none text-black py-1 px-3 resize-none leading-6"
                        ></textarea>
                      </div>
                    </div>
                  ) : (
                    <div className="p-2 w-full">
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full border-orange-600 border-[2px] bg-white rounded  text-base outline-none text-black py-1 px-3 leading-6"
                        />
                      </div>
                    </div>
                  )
                ...
                <div className="p-2 w-full">
                  <button
                    ...
                    className="disabled:opacity-50 py-3 lg:py-4 px-12 lg:px-16 text-white font-semibold rounded-lg text-2xl tracking-widest bg-orange-600 outline-none"
                  >
                    Send Message
                  </button>
                </div>
